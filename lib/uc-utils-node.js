...
//Q:20190122: Prevent Object/Function prototypes collision {
...
UCConnect.Utils.extendFrom = function(parentCls, childPrototype, childStatic) {
    let childProto2 = Object.create(parentCls.prototype);
    function _default_constructor() {
      parentCls.apply(this, arguments);
    }
    childProto2._super = parentCls;
    let childCls;
    if (childPrototype) {
        childCls = childPrototype.constructor;
        UCConnect.Utils.updateFrom(childProto2, childPrototype);
    }
    childCls = childCls || _default_constructor;
    childCls._super = parentCls;
    childProto2._class = childProto2.constructor = childCls;
    if (childStatic) {
        childCls.updateFrom(childStatic);
    }
    
    return childCls;
};

UCConnect.Utils.mapFactory = function(cls, factory) {
  factory.prototype = cls.prototype;
  factory.updateFrom(cls);
...
UCConnect.Utils.extendFrom(Error, {
    constructor: UCConnect.Utils.WebError,
    status: null
});
...
UCConnect.Utils.extendFrom(Error, {
    constructor: UCConnect.Utils.ResourceError,
    resourceID: null
});
...
UCConnect.Utils.extendFrom(UCConnect.Utils.ResourceError, {
    constructor: UCConnect.Utils.ResourceNotFoundError,
    resourceID: null
});
...
UCConnect.Utils.extendFrom(UCConnect.Utils.ResourceError,  {
    constructor: UCConnect.Utils.ResourceConflictError,
    resourceID: null
});
